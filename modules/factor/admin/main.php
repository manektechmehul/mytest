...
class main extends template
{
    ...
    function main()
    {
        ...
        $this->table = 'factor';
        /* #module specific */
        $this->group_name = 'Factors';
        /* #module specific */
        $this->single_name = 'Factor';
        $this->ordered = true;
        $this->order_clause = ' order_num asc ';
        $this->singular = 'a';
        $this->hideable = true;
        ...
        $this->buttons = array(
            ...
            'resources' => array('text' => 'factor resources', 'type' => 'button', 'pattern' => '/modules/factor/admin/resources.php?factor_id=%s'),
        );
        ...
        $this->fields = array(
            ...
            'header_image' => array('name' => 'Header Image', 'formtype' => 'image'),
            'page_image' => array('name' => 'Page Image [List]', 'formtype' => 'image'),
            'thumb' => array('name' => 'Thumbnail[Icon]', 'formtype' => 'image', 'list' => false, 'required' => true, 'size' => 2),
            ...
            'qanda' => array('name' => 'Q and A', 'formtype' => 'fckhtml', 'list' => false, 'required' => false),

        );
        // this will populate the link table - categories
        /* #module specific */
        $this->links = array('category' => array('link_table' => 'factor_category_lookup', 'table' => 'factor_category', 'name' => 'title', 'primary' => 'item_id', 'foreign' => 'category_id'));
    }
    ...
    {
        $this->module_id = db_get_single_value("select id from module where constant = 'SITE_HAS_FACTOR'", "id");
    ...
    function category_checklist($id, $fieldname, $field)
    {
        ...
        /* #module specific */
        $linksql = "SELECT t.id, t.title, l.item_id FROM factor_category t 
LEFT OUTER JOIN factor_category_lookup l ON t.id = l.category_id AND l.item_id = '$id' order by title";
