...
class shop_members extends template {
    ...
    function shop_members() {
        ...
        $this->singular = 'a';
        $this->hidable = true;
        $this->order_clause = ' surname';
        $this->ToolbarSet = 'Default';

        $this->paginated = true;
        $this->paginate_items_per_page = 15;
        ...
        $this->fields = array(
            ...
            'firstname' => array('name' => 'First name', 'formtype' => 'shorttext', 'required' => true, 'list' => true,),
            'surname' => array('name' => 'Surname', 'formtype' => 'shorttext', 'required' => true,  'list' => true,),
