...
class main extends template {
    ...
    function main() {
        ...
        /* #module specific */
        $this->group_name = 'Directories';
        /* #module specific */
        $this->single_name = 'Directory';
        $this->ordered = true;
        ...
        // this will populate the link table - categories
         /* #module specific */
        $this->links = array('category' => array('link_table' => 'directory_category_lookup', 'table' => 'directory_category', 'name' => 'title', 'primary'=>'item_id', 'foreign'=>'category_id'));
    }
	...
	function onload() {
		...
		if ( DIRECTORY_HAS_INLINE_GALLERIES ) {
    ...
    function get_form_data() {
        $this->module_id = db_get_single_value("select id from module where constant = 'SITE_HAS_DIRECTORY'", "id");
   ...
   function category_checklist($id, $fieldname, $field) {
        ...
        /* #module specific */
        $linksql = "SELECT t.id, t.title, l.item_id FROM directory_category t
LEFT OUTER JOIN directory_category_lookup l ON t.id = l.category_id AND l.item_id = '$id' order by title";
