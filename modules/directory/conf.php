...
/* #module specific */
$module_key = 'SITE_HAS_DIRECTORY';
// TODO: register this class name somewhere ??
/* #module specific */
$module_prefix = "DIRECTORY_";
/* #module specific */
$paginate = constant($module_prefix . "PAGINATE");
$paginate_items_per_page = constant($module_prefix . "PAGINATE_ITEMS_PER_PAGE");

$moduleObject = new DirectoryModule($module_path, $paginate,$paginate_items_per_page, $pageUrl, $module_key);
...
$moduleObject->sideboxItemsDisplayed = 5; //constant($module_prefix . "SIDEBOX_NUMBER_OF_ITEMS");
