...
<!-- CS directory searchbox start --> my  module Search box to go here <!-- CS directory searchbox end -->
...
if($page_type_row['path'] == "directory") {
		if ( DIRECTORY_HAS_INLINE_GALLERIES ) {
			$sql       = " SELECT gallery  FROM directory WHERE page_name = '$name_parts[1]'";
