...
class main extends template {
    ...
    function main() {
        ...
        $this->custom_list_sql = 'select * from `profiles` order by profiles_category, surname ';

        $this->group_name = 'Profile Category';
        $this->grouping = " group by  profiles_category ";
        ...
        $this->fields = array(
           ...
           // 'customfunction' => 'category_checklist'),
            'profiles_category' => array('name' => 'Profiles Category', 'formtype' => 'lookup', 'function' => 'category_lookup', 'required' => true),
    ...
    function category_lookup($id) {
        return $this->lookup('profiles_category', 'profiles_category', $id, 'title');
    }
    ...
    function lookupcategorynameforlisting($id) {
        ...
        $sql = " SELECT pc.title FROM `profiles` p
