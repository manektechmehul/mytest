...
if(PROFILES_ON_LEVEL == 0){
    ...
    /* #module specific */
    $submenu = getProfilesSubmenu($menulink);
...
/* #module specific */
function getProfilesSubmenu($menulink) {
    // change trigger
    /* #module specific */
  if(PROFILES_HAS_CATEGORIES != 0){
	...
	$pageMenu = array();	
        ...
        /* #module specific */
		$subnav_sql="SELECT DISTINCT c.* FROM profiles_category_lookup csc
INNER JOIN profiles cs ON cs.id = csc.item_id
INNER JOIN profiles_category c ON c.id = csc.category_id
