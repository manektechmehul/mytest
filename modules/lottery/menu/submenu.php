...
if(LOTTERY_ON_LEVEL == 0){
    ...
    /* #module specific */
    $submenu = getLotterySubmenu($menulink);
...
/* #module specific */
function getLotterySubmenu($menulink) {
    // change trigger
    /* #module specific */
  if(LOTTERY_HAS_CATEGORIES != 0){
	...
	$pageMenu = array();	
        ...
        /* #module specific */
		$subnav_sql="SELECT DISTINCT c.* FROM lottery_category_lookup csc
INNER JOIN lottery cs ON cs.id = csc.item_id
INNER JOIN lottery_category c ON c.id = csc.category_id
