...
class LotteryModule extends PageListModule {
    ...
    function __construct($module_path, $paginate, $paginate_items_per_page, $pageUrl, $module_key) {
        ...
        $this->listName = 'lottery';
        $this->itemName = 'lottery';
        $this->pluralName = 'Lottery';
        $this->singleName = 'Lottery';
        $this->section_page_name = 'Lottery';

        // technical names
        $this->table = 'Lottery';
        $this->categoryTable = 'lottery_category';
        $this->linkTable = 'lottery_category_lookup';
        $this->linkField = 'category_id';
        $this->keyField = 'item_id';

        $this->sideboxListName = 'sideboxlottery'; // ?? odd name
        $this->pageName = $pageName;
        $this->currentCategory = "";

        /* #module specific */
        $this->model = new lotterymodel($pageUrl);
        $this->model->setTable('lottery');

        $this->model->setpublishedField('published');
        $this->model->setOrderField('order_num desc');

        /* #module specific */
        $this->sidebox_filter_key = "lottery";
...
WHERE page_type.config_flag = '" . $module_key . "';";
    ...
    function createSearchBox($hasCategories=false) {
        ...
        $filters[$this->itemName . '_lottery_search_filter'] = array('search_string' => '/<!-- CS ' . $this->sidebox_filter_key . ' searchbox start -->(.*)<!-- CS ' . $this->sidebox_filter_key . ' searchbox end -->/s',
            'replace_string' => '{include file="file:' . $template_file . '"}');
    }
