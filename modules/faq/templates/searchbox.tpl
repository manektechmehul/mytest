  ...
  <div class="docsearchbox">
    ...
    <form action="/{$page_url_parts[0]}/results" method="get" class="document-search">
      ...
      <div class="form-row">
          ...
          {html_options name=category options=$faq_searchCategories selected=$smarty.get.category}
      </div>
      {/if}
      
      <div class="form-row" style="margin:10px 0 0;">
          <input type="submit" src="/images/downloadssearch.png" name="search" value="Search FAQS" class="searchbutton">
      </div>
    </form>
  </div>
</div>
