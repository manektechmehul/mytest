...
class main extends template {
    ...
    function main() {
        ...
        $this->table = 'faq';
        /* #module specific */
        $this->group_name = 'Faqs';
        /* #module specific */
        $this->single_name = 'FAQ';
        $this->ordered = true;
        ...
        $this->fields = array(
            ...
            'question' => array('name' => 'Question', 'formtype' => 'text', 'list' => true, 'required' => true, 'primary' => true),
            'answer' => array('name' => 'Answer', 'formtype' => 'textarea', 'list' => false, 'rows' => 3, 'cols' => 60, 'required' => true),
        ...
        // this will populate the link table - categories
         /* #module specific */
        $this->links = array('category' => array('link_table' => 'faq_category_lookup', 'table' => 'faq_category', 'name' => 'title', 'primary'=>'item_id', 'foreign'=>'category_id'));
    }
    ...
    function get_form_data() {
        $this->module_id = db_get_single_value("select id from module where constant = 'SITE_HAS_FAQ'", "id");
   ...
   function category_checklist($id, $fieldname, $field) {
        ...
        /* #module specific */
        $linksql = "SELECT t.id, t.title, l.item_id FROM faq_category t 
LEFT OUTER JOIN faq_category_lookup l ON t.id = l.category_id AND l.item_id = '$id' order by title";      
