...
<div align="center">
    <table width="450" cellspacing="0" cellpadding="0" style="border:1px solid #000000;">
        ...
        <tr><td bgcolor="#FFFFFF" style="padding:15px 30px 15px 30px;">
                ...
                <p>We have received the next payment in your subscription with our Lottery. Should you need to contact us, your original order (number {$orderDetails.id}). This email is your invoice.</p>
                ...
                <table cellspacing="0" cellpadding="0" style="border:none; border-right:1px solid #000000;" width="100%">
                    ...
                    <tr>
                        {if $orderDetails.collection == 1}
                            <td style="padding:2px 10px; border:1px solid #000000; border-right:none; text-align:right;"> Collection Only </td>
                            <td style="padding:2px 10px; border:1px solid #000000; border-right:none; text-align:left;">
                        ...
                        {else}
                            <td style="padding:2px 10px; border:1px solid #000000; border-right:none; text-align:right;">  Shipping </td>
                            <td style="padding:2px 10px; border:1px solid #000000; border-right:none; text-align:left;">
                                {if $shop_show_vat == '1'}
