...
/* #module specific : change tab name, alt + name + src */
    $on = ($second_admin_tab == 'memorybook') ? 'over' : 'off';
    $second_level_navigavtion .= '<a href="main.php" onmouseout="button_off(this)"
        onmouseover="button_over(this)"><img src="/admin/images/buttons/2ndrowtab-Memorybook-'.$on.'.gif" alt="Memories" name="Memorybook"  /></a>';
