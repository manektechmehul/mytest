...
/* #module specific */
$module_key = 'SITE_HAS_MEMORYBOOK';
// TODO: register this class name somewhere ??
/* #module specific */
$module_prefix = "MEMORYBOOK_";
/* #module specific */
$paginate = constant($module_prefix . "PAGINATE");
$paginate_items_per_page = constant($module_prefix . "PAGINATE_ITEMS_PER_PAGE");

$moduleObject = new MemorybookModule($module_path, $paginate,$paginate_items_per_page, $pageUrl, $module_key);
