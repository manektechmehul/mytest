...
/* #module specific */
$module_key = 'SITE_HAS_MY_HEALTH';
/* #module specific */
$module_prefix = "MY_HEALTH_";
/* #module specific */
$paginate = constant($module_prefix . "PAGINATE");
$paginate_items_per_page = constant($module_prefix . "PAGINATE_ITEMS_PER_PAGE");
// edit the module instance name
$moduleObject = new my_health_module($module_path, $paginate,$paginate_items_per_page, $pageUrl, $module_key);
...
$moduleObject->sideboxItemsDisplayed = constant($module_prefix . "SIDEBOX_NUMBER_OF_ITEMS");
