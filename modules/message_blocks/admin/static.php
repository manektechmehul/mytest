...
class staticpromo extends template 
{
	function __construct()
	{
		$this->template();
		$this->table = 'staticpromo';
		$this->group_name = 'Static Promo Links';
		$this->single_name = 'Static Promo Link';
        $this->ordered = true;
		$this->singular = 'a';
		$this->hideable = true;
		...
		$this->fields = array( 
			...
			//'subheading' => array('name' => 'Sub heading', 'formtype' => 'text', 'list' => true, 'required' => true, 'primary' => true),
