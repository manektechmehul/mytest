...
{if $singleitem.video_type == "1" }
<iframe width="730" height="420" src="//www.youtube.com/embed/{$singleitem.video_id}" frameborder="0" allowfullscreen></iframe>
{/if}
{if $singleitem.video_type == "2" }
<iframe src="//player.vimeo.com/video/{$singleitem.video_id}" width="730" height="420" frameborder="0" webkitallowfullscreen mozallowfullscreen allowfullscreen></iframe>
{/if}
{$singleitem.body}</div>
