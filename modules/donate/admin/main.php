...
class main extends template {
    ...
    function main() {
        ...
        $this->fields = array(
	        ...
	        'display_text' => array('name' => 'Display Text', 'formtype' => 'text','required' => true),

	        //  'category' => array('name' => 'Categories', 'formtype' => 'checklink', 'required' => true, 'not_field' => true, 'link' => 'category', 'customfunction' => 'category_checklist'),
         ...
         //   'thumb' => array('name' => 'Thumbnail', 'formtype' => 'image', 'list' => false, 'required' => true, 'size' => 2),
		   ...
		   // 'description' => array('name' => 'Description', 'formtype' => 'textarea', 'list' => false, 'rows' => 3, 'cols' => 60, 'required' => true),
	        ...
	        'giftaid_checkbox' => array('name' => 'Display Gift Aid Check box', 'formtype' => 'checkbox' ),
	        'free_values' => array('name' => 'Display&nbsp;free&nbsp;values&nbsp;textbox <br>(add whatever amount you choose)', 'formtype' => 'checkbox' ),
	        'fixed_values_display' => array('name' => 'Display fixed values <br>(Must choose a value as dictated by this list)', 'formtype' => 'checkbox' ),
	        'fixed_values' => array('name' => 'For each entry, add a value then : then a description. A new line for each entry.', 'formtype' => 'textarea' ),


	        'text_block1' => array('name' => 'Text Block 1', 'formtype' => 'textarea', 'list' => false, 'rows' => 3, 'cols' => 60),
            'show_block1' => array('name' => 'Show Text Block 1', 'formtype' => 'checkbox' ),
            'text_block2' => array('name' => 'Text Block 2 ', 'formtype' => 'textarea', 'list' => false, 'rows' => 3, 'cols' => 60),
            'show_block2' => array('name' => 'Show Text Block 2', 'formtype' => 'checkbox'),
      ...
      //      'description_seo' => array('name' => 'Description<br>(for SEO)', 'formtype' => 'lookup', 'not_field' => true, 'function' => 'getSEODescription'),
       //     'clear_custom_seo' => array('name' => 'Clear Custom SEO<br> (Check this box then submit)', 'formtype' => 'checkbox', 'not_field' => true),
        ...
        // this will populate the link table - categories
         /* #module specific */
        $this->links = array('category' => array('link_table' => 'donation_category_lookup', 'table' => 'donation_category', 'name' => 'title', 'primary'=>'item_id', 'foreign'=>'category_id'));
    }
    ...
    function get_form_data() {
        $this->module_id = db_get_single_value("select id from module where constant = 'SITE_HAS_DONATE'", "id");
   ...
   function category_checklist($id, $fieldname, $field) {
        ...
        /* #module specific */
        $linksql = "SELECT t.id, t.title, l.item_id FROM donation_category t
LEFT OUTER JOIN donation_category_lookup l ON t.id = l.category_id AND l.item_id = '$id' order by title";
