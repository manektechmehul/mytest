...
class categories extends template {
    ...
    function categories() {
        ...
        /* #module specific */
        $this->custom_list_sql = 'select id, title from donation_category where special = 0 order by order_num ';
        $this->has_page_name = true;
        /* #module specific */
    ...
    function get_crumbs($page) {
       /* #module specific */
        return "<a href='main.php'>Donate Admin</a> > <b>Categories</b>";
    }
