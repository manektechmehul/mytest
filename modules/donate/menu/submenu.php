...
if(DONATE_ON_LEVEL == 0){
    ...
    /* #module specific */
    $submenu = getDonationsSubmenu($menulink);
...
/* #module specific */
function getDonationsSubmenu($menulink) {
    // change trigger
    /* #module specific */
  if(DONATE_HAS_CATEGORIES != 0){
	...
	$pageMenu = array();	
        ...
        /* #module specific */
		$subnav_sql="SELECT DISTINCT c.* FROM donation_category_lookup csc
INNER JOIN donate cs ON cs.id = csc.item_id
INNER JOIN donation_category c ON c.id = csc.category_id
