...
class DonateModule extends PageListModule {
    ...
    function __construct($module_path, $paginate, $paginate_items_per_page, $pageUrl, $module_key) {
        ...
        $this->listName = 'donations';
        $this->itemName = 'donate';
        $this->pluralName = 'Donations';
        $this->singleName = 'Donate';
        $this->section_page_name = 'Donate';

        // technical names
        $this->table = 'Donate';
        $this->categoryTable = 'donation_category';
        $this->linkTable = 'donation_category_lookup';
        $this->linkField = 'category_id';
        $this->keyField = 'item_id';

        $this->sideboxListName = 'sideboxdonations'; // ?? odd name
        $this->pageName = $pageName;
        $this->currentCategory = "";

        /* #module specific */
        $this->model = new donatemodel($pageUrl);
        $this->model->setTable('donate');

        $this->model->setpublishedField('published');
        $this->model->setOrderField('order_num desc');

        /* #module specific */
        $this->sidebox_filter_key = "donate";
...
WHERE page_type.config_flag = '" . $module_key . "';";
    ...
    function createSearchBox($hasCategories) {
        ...
        $filters[$this->itemName . '_donate_search_filter'] = array('search_string' => '/<!-- CS ' . $this->sidebox_filter_key . ' searchbox start -->(.*)<!-- CS ' . $this->sidebox_filter_key . ' searchbox end -->/s',
            'replace_string' => '{include file="file:' . $template_file . '"}');
    }
