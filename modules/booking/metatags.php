...
$module_const = 'SITE_HAS_BOOKING';
$module_table = 'booking';
//-----------------------------------
$tags = new tags();
$tags->module_id = db_get_single_value("SELECT id FROM module WHERE constant = '{$module_const}'");

if($name_parts[1] == ''){
    $tags->tags_sql = "select 'this' as level, 1 as ordernum, m1.* from metatag m1 where ext_id = '{$content_row['content_type_id']}' and module_id = '0'
            union
