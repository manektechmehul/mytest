<?php
	...
	class main extends template {
		function main() {
			...
			/* #module specific */
			$this->table = 'booking_ticket';
			/* #module specific */
			$this->group_name = 'Tickets';
			/* #module specific */
			$this->single_name     = 'Ticket';
			$this->ordered         = true;
			...
			$this->custom_list_sql = 'SELECT * from booking_ticket where booking_id =' . $_GET['parent_id'] . ' order by order_num ';
			$this->buttons         = array(
