...
if(BOOKING_ON_LEVEL == 0){
    ...
    /* #module specific */
    $submenu = getBookingsSubmenu($menulink);
...
/* #module specific */
function getBookingsSubmenu($menulink) {
    // change trigger
    /* #module specific */
  if(BOOKING_HAS_CATEGORIES != 0){
	...
	$pageMenu = array();	
        ...
        /* #module specific */
		$subnav_sql="SELECT DISTINCT c.* FROM booking_category_lookup csc
INNER JOIN booking cs ON cs.id = csc.item_id
INNER JOIN booking_category c ON c.id = csc.category_id
