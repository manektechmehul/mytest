        ...
        foreach ($this->fields as $fieldname => $field) {
            ...
            if ($section_id != $previous_section_id) {
                if (!$first_section) {
                    ...
                    $output .= "</div>";
                    $output .= "<div class='form_section_panel' id='form_section_{$section_id}'>";
                } else {
                    //NOT CORRECT - creates duplicate... $output .= "<table border='0' cellspacing='5' cellpadding='3' style='margin:0' id='form-table'>\n";
                    $output .= "<div class='form_section_panel' id='form_section_{$section_id}' >";
                }
            ...
            // use this variable to add new div desctions        
            //     echo 'form section is ' . $field->getFormSection();        
