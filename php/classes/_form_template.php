...
include_once "./php/classes/encrypt.php";
class form_template {
    ...
    function encrypted_standard_email($site_address, $to_email_address, $from_email_address, $subject) {
        ...
        $attachment = ""; // encrypted zip location
        
        
        $intro = "The following enquiry has been submitted from $site_address.\n\n";
         
        
        
        global $base_path;
        // need to set this as editable b site
        //$key = "default1234";
        ...
        $source = dirname(__FILE__) . '/' . $uuid . '.txt';
        // write the user settings to the source file
      ...
      //  echo $encrypted_string;
        ...
        // note a different mail function - its better with attachments
        send_mail($to_email_address, 'FROM: ' . $from_email_address, $subject, $intro, $intro, $zip);
