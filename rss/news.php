...
//	header('Content-type: application/rss+xml');
	...
	$rss_title = SITE_NAME.' News';
	$rss_description = SITE_NAME.' News';
	$rss_link = $site_address.'/news';
	$rss_xls = 'news.xsl';
	...
	$post_sql = "select id, title, page_name, body as description, unix_timestamp(`date`) date_of_event from news where published = 1";
