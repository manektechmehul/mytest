...
5) add the module tab in the admin menu (admin/admin_header_inc.php)
     ...
     if (SITE_HAS_[[ALLUPPER]] == "1") {
                                show_nav_tab_image("/modules/[[LOWERCASE_NAME]]/admin/main.php", '[[LOWERCASE_NAME]]', '[[LOWERCASE_NAME]]', 'nav-[[LOWERCASE_NAME]]');
                            }
...
if($page_type_row['path'] == "[[MODULE_URL]]") {
		if ( [[ALLUPPER]]_HAS_INLINE_GALLERIES ) {
			$sql       = " SELECT gallery  FROM [[MAIN_TABLE]] WHERE page_name = '$name_parts[1]'";
