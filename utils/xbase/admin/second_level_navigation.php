...
/* #module specific : change tab name, alt + name + src */
    $on = ($second_admin_tab == '[[LOWERCASE_NAME]]') ? 'over' : 'off';    
    $second_level_navigavtion .= '<a href="main.php" onmouseout="button_off(this)" 
        onmouseover="button_over(this)"><img src="/admin/images/buttons/2ndrowtab-[[UPPERCASE_NAME]]-'.$on.'.gif" alt="[[PLURALUPPER]]" name="[[UPPERCASE_NAME]]"  /></a>';
