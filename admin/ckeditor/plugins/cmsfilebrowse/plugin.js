...
//editor.popup( url, width, height, editor.config.fileBrowserWindowFeatures );
        var dialog = new CKEDITOR.dialog(editor, 'cmsfilebrowse');


        dialog.definition.minWidth = 900;
        dialog.definition.minHeight = 540;
        dialog.definition['contents'][0].elements[0].src = url;
...
// The "data" argument may be used to pass the error message to the editor.
    ...
    CKEDITOR.plugins.add('cmsfilebrowse',
        {
            requires:['resize', 'iframedialog'],
...
// CKEDITOR.DIALOG_RESIZE_BOTH
                ...
                CKEDITOR.dialog.add('cmsfilebrowse', function () {
                        return {
